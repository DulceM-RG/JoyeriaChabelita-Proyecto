        ...
        tr.innerHTML = `
            ...
            <td class="acciones">
                <button class="btn-accion btn-editar" onclick="abrirModalEditar('${proveedor.rfc}')" title="Editar">
                    <img src="./src/assets/icon/editar.png" alt="Editar" width="25" height="25">
                </button>
                <button class="btn-accion btn-eliminar" onclick="confirmarEliminar('${proveedor.rfc}', '${proveedor.razonSocial}')" title="Eliminar">
                    <img src="./src/assets/icon/borrar126.png" alt="Eliminar" width="25" height="25">
                </button>
            </td>
        `;
...
// ============================================
function confirmarEliminar(rfc, razonSocial) {
    const confirmacion = confirm(
