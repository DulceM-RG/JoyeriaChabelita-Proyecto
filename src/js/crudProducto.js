    ...
    productos.forEach(producto => {
        ...
        tr.innerHTML = `
            ...
            <td class="acciones">
                ...
                <button class="btn-accion btn-eliminar" onclick="confirmarEliminar('${producto.idProducto}', '${producto.descripcion}')" title="Eliminar">
...
// ============================================
function confirmarEliminar(idProducto, descripcion) {
